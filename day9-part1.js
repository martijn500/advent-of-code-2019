...
const getInputByParameterMode = (mode, index) => {
    switch (mode) {
        case 0: // position
            return input[index];
        case 1: // immediate
...
const setInputByParameterMode = (mode, index, value) => {
    switch (mode) {
        case 0: // position
            input[index] = value;
            break;
        case 2: // relative
            input[index + relativeBase] = value;
            break;
    }
}
...
const compute = () => {
    ...
    for (let i = 0; i < input.length; i++) {
        ...
        const parameter1Mode = getParam(opCodeString, 1);
        const parameter2Mode = getParam(opCodeString, 2);
        const parameter3Mode = getParam(opCodeString, 3);
        const indexParameter1 = input[count + 1];
        const indexParameter2 = input[count + 2];
        const indexParameter3 = input[count + 3];

        let value;
        let value1 = getInputByParameterMode(parameter1Mode, indexParameter1);
        let value2 = getInputByParameterMode(parameter2Mode, indexParameter2);
        ...
        if (opCode === 99) {
            ...
            switch(opCode) {
                case 1:
                    value = value1 + value2;
                    setInputByParameterMode(parameter3Mode, indexParameter3, value);
                    count += 4;
                    break;
                ...
                case 3:
                    ...
                    setInputByParameterMode(parameter1Mode, indexParameter1, value);
                    count += 2;
                    break;
                case 4:
                    output = getInputByParameterMode(parameter1Mode, indexParameter1);
                    count += 2;
                    break;
                case 5:                    
                    if (value1 !== 0) {
